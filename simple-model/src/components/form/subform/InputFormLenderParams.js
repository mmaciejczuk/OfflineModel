...
class InputFormLenderParams extends Component {
  dscrRef = React.createRef();
  tenureRef = React.createRef();
  existingDebtTenureRef = React.createRef();
  termLoanInterestRateRef = React.createRef();
  workingCapInterestRateRef = React.createRef();
  loanStressRef = React.createRef();
  benchmarkGrowthRateRef = React.createRef();
  benchmarkNOIRef = React.createRef();
